...
export default function DownloadApp() {
  return (
    <div className="flex flex-row justify-between px-10 min-h-[480px] h-full mb-12  bg-[url('../assets/downloadbanner.png')] bg-cover bg-no-repeat">
      ...
      <div className='flex flex-col justify-center px-10   space-y-5 w-3/5'>
        ...
        <h3 className="text-1xl font-thin text-gray-900 dark:text-white">
          Et prenez bien soin de votre santé.
        </h3>

        <div className='space-x-3'>
          <button className="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none w-[200px] h-[70px]">
