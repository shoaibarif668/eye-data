...
export default function SearchChips(props) {
  return (
    <div>
        <span className="px-4 py-2 rounded-full   text-siteblue bg-gray-200 font-semibold text-sm flex align-center w-max cursor-pointer active:bg-gray-300 transition duration-300 ease">
